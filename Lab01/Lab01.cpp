...
int main()
{
	...
	// Результат 2038:01:19, тобто дата останнього використання 32 бітного часу – 19 січня 2038 року.

	GetAccuracy();
	// Ðåçóëüòàò 2: âèêëèêàâøè void ôóíêö³þ GetAccuracy ³ç çàñòîñóâàííÿì â í³é öèêëó for ç ³íêðåìåíòîì äî 10 îòðèìàíî íàñòóïí³ ðåçóëüòàòè:
	/*
	Accuracy time: 1 s
	Accuracy clock: 0.0010 s
	Accuracy GetSystemTimeAsFileTime: 0.0010 s
	Accuracy GetSystemTimePreciseAsFileTime: 2e-03 s (â³äì³÷àºòüñÿ äåâ³àö³ÿ 1e-03 s, 2e-03 s, 3e-03 s, 9e-04 s)
	Accuracy GetTickCount: 0.0160 s
	Accuracy RDTSC: 66.0000 tacts (â³äì³÷àºòüñÿ äåâ³àö³ÿ 66.000, 68.000, 72.000, 73.000, 76.000, 81.000 tacts) 
	Accuracy QueryPerfomanceCounter: 1e-06 s
	Accuracy chrono: 2e-06 s (â³äì³÷àºòüñÿ äåâ³àö³ÿ 2å-06 s, 3e-06 s)
	...
	*/
	...
	Query: 49.0000 tacts
	Â³äì³÷àºòüñÿ çíà÷íà ðîçá³æí³ñòü ðåçóëüòàò³â, ùî âåäå çà ñîáîþ âèñíîâîê ïðî çíà÷íó çàòðàòí³ñòü RDTSC 	
	*/

	GetTickCounts();
	/* Ðåçóëüòàò 4: Îòðèìàíî äîñèòü ñõîæ³ ðåçóëüòàòè, òîìó ìîæíà ïåðåäáà÷èòè äîïóñòèì³ñòü âèêîðèñòàííÿ
	GetTickCounts =>
	...
	*/
	...
	/* 5,6,7,8,9,10 - Âèêíîíàíî ðàçîì
	Ðåçóëüòàò 5,6,7
	äëÿ 5 çàâäàííÿ ïðèïóñòèìî, ùî º ìàòðèöÿ N 64 (ïåðåäàìî â ÿêîñò³ àðãóìåíòó 64):
	CalculateMatrix =>
	function: 0.0013
	object: 0.0014
	äëÿ çàâäàííÿ 7
	...
	function: 158.5530
	object: 195.9645
	äëÿ 6 çàâäàííÿ Äëÿ ìóëüòèïë³êàö³¿ äâîõ ìàòðèöü íåîáõ³äíà notation O(n^3), áåðó÷è äî óâàãè òîé ôàêò, ùî âèêîíóºòüñÿ â³äïîâ³äíî òðè öèêëè ïî n ä³é äëÿ êîæíîãî. Äîñÿãòè O(n^2) íåìîæëèâî, íàéøâèäøèé â³äîìèé àëãîðèòì äëÿ ìóëüòèïë³êàö³¿ ìàòðèöü - Êîïïåðñìèòà—Âèíîãðàäà ³ç àñèìïòîòè÷íîþ ñêëàäí³ñòþ O(n^2.3737).
	äëÿ 7 çàâäàííÿ ÿê âæå çàçíà÷àëîñü, äîñÿãòè àñèìïòîòè÷íî¿ ñêëàäíîñò³ O(n^2) íåìîæëèâî, òîìó êð³ì çðîñòàííÿ ê³ëüêîñò³ îïåðàö³é äëÿ ìàòðèöü 512-1024-2048 ³ íàÿâíîñò³ O(n^3), ìàýìî íåë³í³éíå çðîñòàííÿ ÷àñó âèêîíàííÿ îá÷èñëåíü, çàì³ñòü íàïðèêëàä ð³çíèö³ ïðè 512 äî 1024 ó 8 ðàç³â.

	äëÿ 8 çàâäàííÿ âèêîðèñòàíî Release Configuration:
	CalculateMatrix =>
	function: 0.0004
	object: 0.0007
	CalculateMatrix =>
	...
	function: 121.4246
	object: 143.0191
	Ïðèñêîðåííÿ âèêîíàííÿ ïîâ'ÿçàíå ç òèì, ùî â³äïîâ³äíî îô³ö³éíî¿ äîêóìåíòàö³¿(https://docs.microsoft.com/en-us/visualstudio/debugger/how-to-set-debug-and-release-configurations?view=vs-2019), release êîíô³ãóðàö³ÿ íå ìàº ³íôîðìàö³¿ ïðî íàëàãîäæåííÿ ïðîãðàìè ³ º ïîâí³ñòþ îïòèì³çîâàíîþ.

	äëÿ 9 çàâäàííÿ âèêîðèñòàí³ ð³çí³ òèïè äàíèõ äëÿ ìàòðèö³ 1024 int8, int16, int32, __int64, float, double (àðãóìåíò òà êîìàíäè ôóíêö³¿ çì³íåíî íàçàä íà int äëÿ äåìîíñòðàö³¿ ïîïåðåäí³õ çàâäàíü)
	Ðåçóëüòàòè
	__int8	12.9677
	__int16	13.1252
	__int32	13.4119
	...
	äëÿ 10 çàâäàííÿ â ïàïö³ lab01 äëÿ îäíîãî òèïó äàíèõ âèêîðèñòàíî Performance Instrumentation Profiler(Report20191214-1315.vsps) 
	*/
